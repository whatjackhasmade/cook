...
const recipe: Recipe = {
	...
	ingredients: [
		...
		{ name: "Garlic powder", unit: MeasurementUnit.Teaspoons, quantity: "1" },
		{ name: "Dried oregano", unit: MeasurementUnit.Teaspoons, quantity: "1" },
		{ name: "Smoked paprika", unit: MeasurementUnit.Teaspoons, quantity: "1" },
		{
		...
		{ name: "Dijon mustard", unit: MeasurementUnit.Tablespoons, quantity: "1" },
		{
		...
		{ name: "White vinegar", unit: MeasurementUnit.Teaspoons, quantity: "1/4" },
	],
